        ...
        <nav className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex space-x-8">
              <a href="#programs" className="hover:text-blue-600 transition font-semibold">Programs</a>
              <a href="#about" className="hover:text-blue-600 transition font-semibold">About</a>
              <a href="#testimonials" className="hover:text-blue-600 transition font-semibold">Testimonials</a>
              <a href="#contact" className="hover:text-blue-600 transition font-semibold">Contact</a>
            </div>
          ...
          {isMenuOpen && (
            <div className="md:hidden absolute top-full left-0 right-0 bg-white p-4 shadow-lg">
              <div className="flex flex-col space-y-4">
                <a href="#programs" className="text-black hover:text-blue-600 transition">Programs</a>
                <a href="#about" className="text-black hover:text-blue-600 transition">About</a>
                <a href="#testimonials" className="text-black hover:text-blue-600 transition">Testimonials</a>
                <a href="#contact" className="text-black hover:text-blue-600 transition">Contact</a>
                <button className="bg-blue-600 text-white px-6 py-2 rounded-full font-semibold hover:bg-blue-700 transition">
                  Get Started
                </button>
              </div>
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              ...
              <div className="flex space-x-4">
                <button className="bg-blue-600 text-white px-8 py-3 rounded-full font-semibold hover:bg-blue-700 transition flex items-center">
